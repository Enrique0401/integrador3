...
public class TablaClienteAdmin extends javax.swing.JPanel implements Observador {

    private DefaultTableModel modelo;
    private final IClienteService usuarioService = new ClienteService(new ClienteRepositorio());

    public TablaClienteAdmin() {
        initComponents();
    ...
    private void cargarUsuarios() {
        ...
        for (Cliente u : lista) {
            if (u.getRol() != null && u.getRol().equalsIgnoreCase("ROLE_ADMIN")) {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try {
            ...
            Cliente nuevo = new ClienteBuilder()
                    ...
                    .conRol("ROLE_ADMIN") // asigna el rol por defecto
